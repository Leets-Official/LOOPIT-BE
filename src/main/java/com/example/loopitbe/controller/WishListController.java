...
public class WishListController {
    ...
    public ResponseEntity<ApiResponse<String>> togglePost(@Valid @RequestBody PostWishlistToggleRequest dto, @Parameter(hidden = true) @AuthenticationPrincipal Long userId) {
        String status = service.togglePostWishList(dto, userId);
    ...
    @GetMapping("/post")
    public ResponseEntity<ApiResponse<List<SellPostWishListResponse>>> getMyPostWishList(@Parameter(hidden = true) @AuthenticationPrincipal Long userId) {
    ...
    public ResponseEntity<ApiResponse<String>> toggleShop(@Valid @RequestBody ShopWishlistToggleRequest dto, @Parameter(hidden = true) @AuthenticationPrincipal Long userId) {
        String status = service.toggleShopWishList(dto, userId);
    ...
    @GetMapping("/shop")
    public ResponseEntity<ApiResponse<List<ShopWishListResponse>>> getMyShopWishList(@Parameter(hidden = true) @AuthenticationPrincipal Long userId) {
    ...
    @PostMapping("/shop/check")
    public ResponseEntity<ApiResponse<List<IsShopInWishListResponse>>> isShopInWishList(@Valid @RequestBody IsShopInWishListRequest dto, @Parameter(hidden = true) @AuthenticationPrincipal Long userId) {
        List<IsShopInWishListResponse> responses = service.checkShopWishList(dto, userId);
